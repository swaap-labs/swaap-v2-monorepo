...
export class SafeguardPoolEncoder {
  ...
  /**
   * Encodes the userData parameter for providing the initial liquidity to a SafeguardPool
  ...
  /**
   * Encodes the userData parameter for joining a SafeguardPool proportionally to receive an exact amount of BPT
  ...
  /**
   * Encodes the userData parameter for joining a SafeguardPool with exact token inputs
  ...
  /**
   * Encodes the userData parameter for exiting a SafeguardPool by removing tokens in return for an exact amount of BPT
   * @param bptAmountIn - the exact amount of BPT to be burned
   */
